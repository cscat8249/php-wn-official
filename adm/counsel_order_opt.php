...
<section id="anc_scf_book">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            ...
            <td colspan="3"><?php echo gen_single_selectbox("","input5",  Array("선택항목","필수","사용안함"), Array("1","2","0"),$csconfig['input5'],''); ?> <a href="counsel_open.php?item=input5&inum=1&itemname=입력형5" target="_blank" class="btn_frmline win_scrap">입력형 5 항목수정</a> <?php echo ($csconfig['input5'])?'<span class="blue">사용</span>':'<span class="red">사용안함</span>';?></td>
        </tr>
        </tbody>
        </table>
    </div>
...
<section id="anc_scf_book">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            ...
            <td colspan="3"><?php echo gen_single_selectbox("","select5",   Array("선택항목","필수","사용안함"), Array("1","2","0"),$csconfig['select5'],''); ?> <a href="counsel_open.php?item=select5&inum=2&itemname=선택형5" target="_blank" class="btn_frmline win_scrap">선택형 5 항목수정</a> <?php echo ($csconfig['select5'])?'<span class="blue">사용</span>':'<span class="red">사용안함</span>';?></td>
        </tr>
        </tbody>
        </table>
    </div>
...
<section id="anc_scf_book">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            ...
            <td colspan="3"><?php echo gen_single_selectbox("","radio5",   Array("선택항목","필수","사용안함"), Array("1","2","0"),$csconfig['radio5'],''); ?> <a href="counsel_open.php?item=radio5&inum=3&itemname=라디오박스형5" target="_blank" class="btn_frmline win_scrap">라디오박스형 5 항목수정</a> <?php echo ($csconfig['radio5'])?'<span class="blue">사용</span>':'<span class="red">사용안함</span>';?></td>
        </tr>
        </tbody>
        </table>
    </div>
...
<section id="anc_scf_check">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            ...
            <td colspan="3"><?php echo gen_single_selectbox("","check5",   Array("선택항목","필수","사용안함"), Array("1","2","0"),$csconfig['check5'],''); ?> <a href="counsel_open.php?item=check5&inum=4&itemname=체크박스형5" target="_blank" class="btn_frmline win_scrap">체크박스형 5 항목수정</a> <?php echo ($csconfig['check5'])?'<span class="blue">사용</span>':'<span class="red">사용안함</span>';?></td>
        </tr>
        </tbody>
        </table>
    </div>
...
<section id="anc_scf_txt">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            ...
            <td colspan="3"><?php echo gen_single_selectbox("","txt3",  Array("선택항목","필수","사용안함"), Array("1","2","0"),$csconfig['txt3'],''); ?> <a href="counsel_open.php?item=txt3&inum=5&itemname=긴문장입력형3" target="_blank" class="btn_frmline win_scrap">긴문장입력형 3 항목수정</a> <?php echo ($csconfig['txt3'])?'<span class="blue">사용</span>':'<span class="red">사용안함</span>';?></td>
        </tr>
        </tbody>
        </table>
    </div>
