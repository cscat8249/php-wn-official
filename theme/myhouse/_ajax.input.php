...
?>
<?php
$iconlist = array("fa-500px","fa-address-book","fa-address-book-o","fa-address-card","fa-address-card-o","fa-adjust","fa-adn","fa-align-center","fa-align-justify","fa-align-left","fa-align-right",
...
<div class="modal-dialog modal-dialog-centered" role="document">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h3><?php echo $ut;?> 설정</h3>
		</div>
		<div class="modal-body">
			<form id="<?php echo $ut;?>_form">
			<input type="hidden" name="theme_edit" value="ok">
			<input type="hidden" name="theme_type" value="<?php if($ut=='botable'){ echo $botable;}else{ echo'index';}?>">
			<input type="hidden" name="theme_type_position" value="<?php echo $ut;?>">
			<?php if($ut=='about'){?>
			<div class="">
				<label class="">상단 문구</label>
				<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('about',0);?>">
			</div>
			<div class="mt-2">
				<label class="">하단 문구</label>
				<textarea name="content[]" class="border border-dark p-2  text-dark form-control rounded-0"><?php echo section('about',1);?></textarea>
			</div>
			<div class="row mt-2">
				<div class="col-sm-6 ">
					<label class="">배경 이미지</label>
					<select name="content[]" id="about_img" class="border border-dark form-control rounded-0">
					<?php imgselect('images/bg',section('about','2'));?>
					</select>
				</div>
				<div class="col-sm-6">
					<label class="">우측 이미지</label>
					<select name="content[]" id="about_img" class="border border-dark form-control rounded-0">
					<?php imgselect('images',section('about','3'));?>
					</select>
				</div>
			</div>
			<div class="row mt-2">
				<div class="col-sm-6 ">
					<label class="">버튼이름</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('about',4);?>">
				</div>
				<div class="col-sm-6">
					<label class="">버튼링크</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('about',5);?>">
				</div>
			</div>
			<?php }?>
			<?php if($ut=='toped'){?>
			<div class="row mb-10">
				<div class="col-sm-12">
					<label class="">BOX 1 아이콘</label>
					<select name="content[]" class="form-control rounded-0 border border-dark">
						<?php for($i=0; $i<count($iconlist); $i++){?>
						<option value="<?php echo $iconlist[$i];?>" <?php if(section('toped',0)==$iconlist[$i]) echo 'selected';?>>
							<?php echo $iconlist[$i];?>
						</option>
						<?php }?>
					</select>
				...
				<div class="col-sm-12">
					<label class="">BOX 1 타이틀</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('toped',1);?>">
				</div>
				<div class="col-sm-12">
					<label class="">BOX 1 설명</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('toped',2);?>">
				</div>
				<div class="col-sm-12">
					<label class="">BOX 1 버튼</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('toped',3);?>">
				</div>
				<div class="col-sm-12">
					<label class="">BOX 1 링크</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('toped',4);?>">
				</div>
			</div>
			...
			<div class="row mb-10">
				<div class="col-sm-12">
					<label class="">BOX 2 아이콘</label>
					<select name="content[]" class="form-control rounded-0 border border-dark">
						<?php for($i=0; $i<count($iconlist); $i++){?>
						<option value="<?php echo $iconlist[$i];?>" <?php if(section('toped',5)==$iconlist[$i]) echo 'selected';?>>
							<?php echo $iconlist[$i];?>
						</option>
						<?php }?>
					</select>
				...
				<div class="col-sm-12">
					<label class="">BOX 2 타이틀</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('toped',6);?>">
				</div>
				<div class="col-sm-12">
					<label class="">BOX 2 설명</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('toped',7);?>">
				</div>
				<div class="col-sm-12">
					<label class="">BOX 2 버튼</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('toped',8);?>">
				</div>
				<div class="col-sm-12">
					<label class="">BOX 2 링크</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('toped',9);?>">
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-12">
					<label class="">BOX 3 아이콘</label>
					<select name="content[]" class="form-control rounded-0 border border-dark">
						<?php for($i=0; $i<count($iconlist); $i++){?>
						<option value="<?php echo $iconlist[$i];?>" <?php if(section('toped',10)==$iconlist[$i]) echo 'selected';?>>
							<?php echo $iconlist[$i];?>
						</option>
						<?php }?>
					</select>
				...
				<div class="col-sm-12">
					<label class="">BOX 3 타이틀</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('toped',11);?>">
				</div>
				<div class="col-sm-12">
					<label class="">BOX 3 설명</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('toped',12);?>">
				</div>
				<div class="col-sm-12">
					<label class="">BOX 3 버튼</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('toped',13);?>">
				</div>
				<div class="col-sm-12">
					<label class="">BOX 3 링크</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('toped',14);?>">
				</div>
			</div>
			<?php }?>
		...
		<?php if($ut=='online'){?>
			<div class="row mb-10">
				<div class="col-sm-12">
					<label class="">타이틀</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('online',0);?>">
				</div>
				<div class="col-sm-12">
					<label class="">하단 설명</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('online',1);?>">
				</div>
				<div class="col-sm-12">
					<label class="">우측타이틀</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('online',2);?>">
				</div>
				<div class="col-sm-12">
					<label class="">문의 저장 게시판</label>
					<select class="form-control w-100 rounded-0 border border-dark" name="content[]">
					<?php boartlist(section('online',3));?>
					</select>
				</div>
				<div class="col-sm-12">
					<label class="">등록버튼이름</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('online',4);?>">
				</div>
				<div class="col-sm-12">
					<label class="">섹션 배경화면</label>
					<select name="content[]" id="" class="border border-dark form-control rounded-0">
					<?php imgselect('images/bg',section('online','5'));?>
					</select>
				</div>
			</div>
			<?php }?>
			...
			<div class="row mb-10">
				<div class="col-sm-12">
					<label class="">섹션 배경화면</label>
					<select name="content[]" id="" class="border border-dark form-control rounded-0">
					<?php imgselect('images/bg',section('news','0'));?>
					</select>
				</div>
				<div class="col-sm-12">
					<label class="">타이틀</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('news',1);?>">
				</div>
				<div class="col-sm-12">
					<label class="">하단설명</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('news',2);?>">
				</div>
				<div class="col-sm-12">
					<label class="">버튼이름</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('news',3);?>">
				</div>
				<div class="col-sm-12">
					<label class="">버튼URL</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('news',4);?>">
				</div>
				<div class="col-sm-3">
					<label class="">최근게시물1</label>
					<select class="form-control w-100 rounded-0 border border-dark" name="content[]">
						<?php boartlist(section('news',5));?>
					</select>
				</div>
				<div class="col-sm-3">
					<label class="">최근게시물2</label>
					<select class="form-control w-100 rounded-0 border border-dark" name="content[]">
						<?php boartlist(section('news',6));?>
					</select>
				</div>
				<div class="col-sm-3">
					<label class="">최근게시물3</label>
					<select class="form-control w-100 rounded-0 border border-dark" name="content[]">
						<?php boartlist(section('news',7));?>
					</select>
				</div>
			...
			<div class="row mb-10">
				<div class="col-sm-12">
					<label class="">섹션 배경화면</label>
					<select name="content[]" id="" class="border border-dark form-control rounded-0">
					<?php imgselect('images/bg',section('cont','0'));?>
					</select>
				</div>
				<div class="col-sm-12">
					<label class="">타이틀</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('cont',1);?>">
				</div>
				<div class="col-sm-12">
					<label class="">하단설명</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('cont',2);?>">
				</div>
				<div class="col-sm-12">
					<label class="">주소</label>
					<input type="text" name="content[]" class="border border-dark text-dark p-2  form-control w-100 rounded-0" value="<?php echo section('cont',3);?>">
				</div>
			</div>
			<?php }?>
			...
			<div class="row mb-10">
				<div class="col-sm-12">
					<label class=""><?php echo $botable;?> 섹션 배경화면</label>
					<select name="content[]" id="" class="border border-dark form-control rounded-0">
					<?php imgselect('images/bg',section('botable','0'));?>
					</select>
				</div>
			</div>
			<?php }?>
		...
		<div class="modal-footer">
			<a href="#" class="vbtn vbtn-sm vbtn-dark" data-dismiss="modal">닫기</a>
			<button type="submit" class="vbtn vbtn-sm vbtn-danger vbtn-square set_ok" data-id="<?php echo $ut;?>">등록</button>
		</div>
	</div>
</div>