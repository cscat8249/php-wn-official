...
<style>
	...
	#mainImg{text-align:center; border:1px solid #ddd;}
	#mainImg img{width:900px;height:auto;}
	#imgList{list-style:none; padding:0;*zoom:1; width:900px; margin:10px auto 0 auto;}
	#imgList:after{content:""; display:block; clear:both;}
	#imgList li{float:left;padding:0 5px;margin:0px; }
	#imgList li img{width:170px;height:110px;}
