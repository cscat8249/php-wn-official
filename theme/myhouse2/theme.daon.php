...
$tmenu_ = "";     $_SERVER['REDIRECT_URL'] = isset($_SERVER['REDIRECT_URL']) ? $_SERVER['REDIRECT_URL'] : '';
...
$MS_Explorer = false;
if ( preg_match("/MSIE*/", $_SERVER["HTTP_USER_AGENT"]) || preg_match("/Trident*/", $_SERVER["HTTP_USER_AGENT"] &&  preg_match("/rv:11.0*/", $_SERVER["HTTP_USER_AGENT"] &&  preg_match("/Gecko*/", $_SERVER["HTTP_USER_AGENT"]) ) )){
	$MS_Explorer = true;
}
...
if($row_mm['co'] == 0){
	sql_query("INSERT INTO `{$g5['menu_table']}` VALUES (255,'10','BRAND','{$G5_THEME_URL_A}/html/brand/01.php','self',0,1,1),(256,'1010','브랜드스토리','{$G5_THEME_URL_A}/html/brand/01.php','self',0,1,1),(257,'1020','연혁','{$G5_THEME_URL_A}/html/brand/02.php','self',0,1,1),(280,'1030','인증서','{$G5_BBS_URL_A}/board.php?bo_table=cer','self',0,1,1),(260,'1040','오시는길','{$G5_THEME_URL_A}/html/brand/03.php','self',0,1,1),(261,'1050','전체테마보기','http://daontheme.cafe24.com','blank',0,1,1),(262,'20','STORE','{$G5_THEME_URL_A}/html/store/01.php','self',0,1,1),(263,'2010','매장정보 Type01','{$G5_THEME_URL_A}/html/store/01.php','self',0,1,1),(264,'2020','매장정보 Type02','{$G5_BBS_URL_A}/board.php?bo_table=store','self',0,1,1),(265,'30','MENU','{$G5_BBS_URL_A}/board.php?bo_table=menu1','self',0,1,1),(266,'3010','메뉴 갤러리형','{$G5_BBS_URL_A}/board.php?bo_table=menu1','self',0,1,1),(267,'3020','메뉴 리스트형','{$G5_BBS_URL_A}/board.php?bo_table=menu2','self',0,1,1),(268,'40','FRANCHISE','{$G5_THEME_URL_A}/html/franchise/01.php','self',0,1,1),(269,'4010','창업경쟁력','{$G5_THEME_URL_A}/html/franchise/01.php','self',0,1,1),(270,'4020','개설절차','{$G5_THEME_URL_A}/html/franchise/02.php','self',0,1,1),(278,'4030','인테리어','{$G5_BBS_URL_A}/board.php?bo_table=interior','self',0,1,1),(279,'4040','창업상담','{$G5_BBS_URL_A}/board.php?bo_table=online1','self',0,1,1),(271,'50','CUSTOMER','{$G5_BBS_URL_A}/board.php?bo_table=notice','self',0,1,1),(272,'5010','공지사항','{$G5_BBS_URL_A}/board.php?bo_table=notice','self',0,1,1),(273,'5020','질문과답변','{$G5_BBS_URL_A}/board.php?bo_table=qa','self',0,1,1),(274,'5030','유투브동영상','{$G5_BBS_URL_A}/board.php?bo_table=youtube','self',0,1,1),(275,'5040','갤러리','{$G5_BBS_URL_A}/board.php?bo_table=gallery','self',0,1,1),(276,'5050','통합검색','{$G5_BBS_URL_A}/search.php','self',0,1,1),(277,'5060','자주하시는질문','{$G5_BBS_URL_A}/faq.php','self',0,1,1);");
}