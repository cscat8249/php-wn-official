...
$second_menu_view = false; //2차메뉴가 필요없으시면 false 로 바꾸세요. 2차메뉴 삭제로 인해 전체 css파일에서 메뉴 배경과 높이를 조정하셔야 합니다.(전체css파일명은 설명서 pdf 파일에서 확인가능)
...
//1차 메뉴 입력
$first_menu["브랜드"] = G5_THEME_URL."/html/brand/01.php";
$first_menu_target["브랜드"] = "_self";
$first_menu_so_title["브랜드"] = "";	//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.

$first_menu["서비스 안내"] = G5_THEME_URL."/html/brand/02.php";
$first_menu_target["서비스 안내"] = "_self";
$first_menu_so_title["서비스 안내"] = "맛과 정성으로 보답하겠습니다.";

$first_menu["스토리"] = G5_THEME_URL."/html/franchise/02.php";
$first_menu_target["스토리"] = "_self";
$first_menu_so_title["스토리"] = "";	//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.

$first_menu["지원센터"] = G5_BBS_URL."/write.php?bo_table=fran";
$first_menu_target["지원센터"] = "_self";
$first_menu_so_title["지원센터"] = "새로운 소식을 알려드립니다.";



//2차 메뉴 입력
/***			브랜드			***********************************************************************/
$second_menu["브랜드"]["소개"] = G5_THEME_URL."/html/brand/01.php";
$second_menu_target["브랜드"]["소개"] = "_self";
$second_menu_so_title["브랜드"]["소개"] = "";//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.

$second_menu["브랜드"]["비전"] = G5_THEME_URL."/html/brand/05.php";
$second_menu_target["브랜드"]["비전"] = "_self";
$second_menu_so_title["브랜드"]["비전"] = "";//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.



/***			서비스 안내			***********************************************************************/
$second_menu["서비스 안내"]["광고지원"] = G5_THEME_URL."/html/brand/02.php";
$second_menu_target["서비스 안내"]["광고지원"] = "_self";
$second_menu_so_title["서비스 안내"]["광고지원"] = "고객님을 위한 특별한 베어밀크";

$second_menu["서비스 안내"]["기술지원"] = G5_THEME_URL."/html/brand/03.php";
$second_menu_target["서비스 안내"]["기술지원"] = "_self";
$second_menu_so_title["서비스 안내"]["기술지원"] = "맛과 정성으로 보답하겠습니다.";

$second_menu["서비스 안내"]["메뉴"] = G5_BBS_URL."/board.php?bo_table=menu";
$second_menu_target["서비스 안내"]["메뉴"] = "_self";
$second_menu_so_title["서비스 안내"]["메뉴"] = "우리집놀러와 메뉴를 소개합니다.";



/***			스토리			***********************************************************************/
$second_menu["스토리"]["스마트체험"] = G5_THEME_URL."/html/franchise/3.php";
$second_menu_target["스토리"]["스마트체험"] = "_self";
$second_menu_so_title["스토리"]["스마트체험"] = "";//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.

$second_menu["스토리"]["우와갤러리"] = G5_BBS_URL."/board.php?bo_table=gallery";
$second_menu_target["스토리"]["우와갤러리"] = "_self";
$second_menu_so_title["스토리"]["우와갤러리"] = "";//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.



/***			지원센터		***********************************************************************/
$second_menu["지원센터"]["상담예약"] = G5_BBS_URL."/write.php?bo_table=fran";
$second_menu_target["지원센터"]["상담예약"] = "_self";
$second_menu_so_title["지원센터"]["상담예약"] = "우리집놀러와에 물어보세요.";

$second_menu["지원센터"]["뉴스"] = G5_BBS_URL."/board.php?bo_table=notice";
$second_menu_target["지원센터"]["뉴스"] = "_self";
$second_menu_so_title["지원센터"]["뉴스"] = "새로운 소식을 알려드립니다.";

$second_menu["지원센터"]["칭찬/개선"] = G5_BBS_URL."/board.php?bo_table=qna";
$second_menu_target["지원센터"]["칭찬/개선"] = "_self";
$second_menu_so_title["지원센터"]["칭찬/개선"] = "소중한 의견을 올려주세요.";
...
if($daon_admin_menu == true){	
	unset($first_menu, $first_menu_target);
