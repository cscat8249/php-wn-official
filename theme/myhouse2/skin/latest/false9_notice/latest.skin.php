...
<div class="main_latest">
  ...
  <?php } ?>
			...
			<div class="li01_2 navi">
				<img class="prev" src="<?php echo $latest_skin_url ?>/img/main_notice_bt_l.png" style="cursor:pointer"> 
				<img class="next" src="<?php echo $latest_skin_url ?>/img/main_notice_bt_r.png" style="cursor:pointer">
			</div>
		</div>
	</div>
</div>
