...
<style>
	@media screen and (max-width: 1200px) {	
		.store_view_left{width:50%;}
		.store_view_right{width:45%;}
		.store_view_left .swiper-slide img{width:100%;}
	}
	@media screen and (max-width: 768px) {	
		.store_view_left{width:100%; margin-bottom:15px;}
		.store_view_right{width:100%;}
	}
</style>
<article id="bo_v" style="width:<?php echo $width; ?>">

	<div style="margin-bottom:20px; overflow:hidden;">
		<div class="store_view_left">
			<div class="swiper-container1" style="overflow:hidden; position:relative;  ">
				<div class="swiper-wrapper">
					...
					while($rowb = sql_fetch_array($rsb)){
						...
						if($rowb['bf_file']){							
						 ...
						 $tfarray_file = thumbnail($rowb['bf_file'], G5_DATA_PATH.'/file/'.$bo_table, G5_DATA_PATH.'/file/'.$bo_table, 720, 450, true, true);
				...
				<div class="swiper-button-next1" style="display:none; background-image:url('<?php echo G5_THEME_URL;?>/html/image/visual_next_on.png');left:20px;right:auto; "></div>
				<div class="swiper-button-prev1" style="display:none; background-image:url('<?php echo G5_THEME_URL;?>/html/image/visual_prev_on.png');left:20px;right:auto; "></div>
			</div>
		...
		<div style="text-align:center; margin:50px auto;" class="">
			<a href="<?php if($search_href) echo $search_href; else echo $list_href; ?>" class="btn btn_b011"><i class="fa fa-list" aria-hidden="true"></i><span>목록으로</span></a>
			<!-- <a href="#none" class="btn_ok2">제품구매</a> -->
		</div>
...
;				
    ...
    <section id="bo_v_atc">
		...
		<div style="clear:both; border-bottom:1px solid #333; margin:40px auto; font-size:1.5em; margin-bottom:0px !important;" class="dt_title">Location</div>
		<div>
