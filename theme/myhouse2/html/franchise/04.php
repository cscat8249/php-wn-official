...
?>
	...
	<section class="scontents">
		...
		<p class="eng"><span class="fc_pointer">베어밀크</span> 인테리어</p>
		<p class="stitle">인테리어 안내해드립니다.</p>


					<?php 
						$daon_category = "";		//카테고리명 카테고리를 사용하지 않고 전체 출력하실때는  값을 비웁니다.
						echo daontheme_lastest('theme/splide', "in1", 5, 17);	//daontheme_lastest("theme/daon_simple", "게시판테이블명", 출력개수, 타이틀길이);
					?>
